...
<?php echo form_open('vendedor/verify_user'); ?>
    ...
    <div class="form-signin">       
      ...
      <h3>Ingrese el email</h3> <br>
       </div>
          <input id="email" type="text" name="email" placeholder="email" required class="form-control input-lg"/>
          <br>
          <input type="submit" class="btn btn-lg btn-primary btn-block" value="Crear Gift Card" />
          <br>  
    </div>

    <a href="vendedor/logout">Logout</a>
