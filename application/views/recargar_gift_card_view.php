...
<html>
<head>
    <title>Agregar dinero Gift Cards</title>
      ...
      <h3>Recargar Gift Cards</h3> <br>
          ...
          <?php 
              if ($entrada == 0) {
                ...
                <label><input type='checkbox' value='1' name='entrada' id='entrada'> Incluir Entrada para el siguiente evento?</label>
              </div>
              <br>";
              } else if ($entrada == 1) {
                echo "<div class='checkbox text-center'>
                <input id='entradaHidden' type='hidden' value='1' name='entrada'>
                <p>Este usuario ya tiene una entrada comprada para el siguiente show </p>
              </div>
              <br>";
              } else {
                echo "<p>Hubo un error y no sabemos el estado de las entradas de este usuario</p>";
              }
          ?>
          

          <br>
          <input type="submit" class="btn btn-lg btn-primary btn-block" value="Recargar Gift Card" />
          <br>  
    </div>
